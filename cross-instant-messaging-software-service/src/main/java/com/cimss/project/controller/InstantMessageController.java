...
public class InstantMessageController {
	...
	@Operation(summary = "刪除群組", description = "必須用該群組的API KEY，否則會驗證失敗")
	...
	@Operation(summary = "新增群組管理員", description = "必須用該群組的API KEY，否則會驗證失敗")
	...
	@Operation(summary = "刪除群組管理員", description = "必須用該群組的API KEY，否則會驗證失敗")
